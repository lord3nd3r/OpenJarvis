...
4. **"How I set this up →"**: a link to the relevant [Tutorial](../tutorials/index.md), [User Guide](../user-guide/cli.md), or [Recipe](https://github.com/lord3nd3r/OpenJarvis/tree/main/src/openjarvis/recipes/data).
