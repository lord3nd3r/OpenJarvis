...
on launch / every 30 min
        │
        ▼
GET https://github.com/lord3nd3r/OpenJarvis/releases/download/desktop-latest/latest.json
        │
        ▼
...
curl -fsSL https://github.com/lord3nd3r/OpenJarvis/releases/download/desktop-latest/latest.json | jq .
